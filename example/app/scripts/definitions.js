(function(cubefilter, d3, scope) {
  const ndx = scope.ndx =cubefilter.cube();
  ...
  typeof cubefilter === 'undefined' ? require('cubefilter') : cubefilter,
  typeof d3 === 'undefined' ? require('d3') : d3,
